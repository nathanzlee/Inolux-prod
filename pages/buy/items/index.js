...
import ItemsTable from '../../../components/buy/items/items'
        ...
        <div class="h-[100vh] w-[100vw]">
            ...
            <div class="w-full h-full bg-gray-100 p-10">
                <div className="sm:px-6 lg:px-8">
                    ...
                    <ItemsTable data={items} loading={loading} edit={user ? (user.department == 'Operations' || user.level == 3) : false}/>
                    <Pagination items={items.length} page={page} onChange={(page) => {setPage(page)}}/>
                </div>
                {alert && ((router.query.success == 'true') ? (
                    <div className="rounded-md bg-green-50 p-4 absolute bottom-10">
                        <div className="flex">
                            ...
                            <div className="ml-3">
                                <p className="text-sm font-medium text-green-800">Successfully {(router.query.action == 'new') ? 'created' : 'updated'} item!</p>
                            </div>
